...
export default async function handler(req, res) {
  ...
  try {
    const { firstName, lastName, email, attending, guestCount, plusOneName, dietary, submittedAt } = req.body;
      ...
      body: JSON.stringify({
        ...
        properties: {
          ...
          'Dietary Restrictions': {
            select: { name: { 'none': 'None', 'vegetarian': 'Vegetarian', 'vegan': 'Vegan', 'gluten-free': 'Gluten-Free', 'halal': 'Halal', 'other': 'Other' }[dietary] || 'None' }
          },
          'Submitted At': {
