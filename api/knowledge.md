# Wedding Concierge Knowledge Base — Caline & Bashar

> This is the single source of truth for the Ask-AI concierge. Everything the AI
> tells guests must come from this file (plus the general scope rules in the
> system prompt). All facts here are drawn from the wedding website and The Margi
> Farm brochure. If something is not in this file, the AI does not know it yet —
> it should say so rather than guess. Couple: edit this file to keep answers correct.
...
## The Venue — The Margi Farm

- The Margi Farm is the countryside estate of **The Margi Hotel** on the Athens Riviera.
- A **ten-acre (10-acre) organic farm** of olive groves, vineyards, and gardens, located in **Kalyvia, Attica**, just minutes from Athens International Airport.
- The farm was created in **2014** by the **Agiostratitis family** (Yiagos & Theo) to supply their home, hotel, and restaurants with organic produce, using traditional, sustainable farming methods.
- Alongside the gardens, olive groves, and vineyards, the farm has chickens, goats, horses, and a rescue donkey named Billy. It has 100-year-old olive trees and vineyards used to make homemade Tsipouro.
- **Dining:** Menus are crafted by Michelin-starred chef **Panagiotis Giakalis**, served farm-to-table with produce grown on the farm.
- **Website:** https://margifarm.gr/
- **Map location (coordinates):** 37.84874, 23.912944 (Kalyvia / Thorikou, East Attica)

### Event spaces on the farm (from the brochure)
- **The Glasshouse Area** — a light, bright glasshouse surrounded by vegetable gardens; romantic at night, with a large open-fire kitchen.
- **The Family Table** — a large monastery table under a pergola with an open-fire kitchen, for buffets and family-style dining (seats ~20 at the table, more with added tables).
- **The Olive Grove Area** — alfresco dining among rows of olive trees; tables among the trees or a tent for a bespoke setup.

---

## Travel — Getting There

- Fly into **Athens International Airport "Eleftherios Venizelos" (ATH)** — Greece's main hub, with direct flights from across Europe, the Middle East, and North America.
- The Margi Farm is just **~15 minutes** from the airport.
...
## Travel — Entry, Visa & Money

- Greece is part of the **EU and the Schengen Area**. Most visitors (US, UK, EU, and many others) need **no visa for short stays**.
- The currency is the **Euro (€)**.
- Note: the EU's new **ETIAS** travel authorisation is expected in late 2026 — guests should check official EU sources closer to their trip.

## Travel — Weather

- Early September in Athens is **warm and dry** — around **28–32°C (82–90°F)** by day, with balmy evenings.
- Perfect for an outdoor celebration; pack light, breathable fabrics and a layer for later in the night.

---

## Where to Stay

These are the couple's favourite suggestions. Room blocks and booking details are still being finalised (see "Not Yet Confirmed").

- **The Margi Hotel** — The venue's sister property in Vouliagmeni on the Athens Riviera, where much of the family and many guests will stay (~30 minutes to the Farm). Website: https://www.themargi.gr/
- **Sofitel Athens Airport** — A two-minute walk from the airport and ~15 minutes to the Farm; ideal for easy arrivals and departures.
- **Four Seasons Astir Palace** — A landmark luxury beach resort on the Vouliagmeni peninsula, with private beaches and several restaurants. Website: https://www.fourseasons.com/athens/
- **Academias Hotel** — An Autograph Collection hotel in central Athens (near Syntagma & the Acropolis), for guests who'd like to stay in the city. Website: https://www.academiashotel.com/
- **Vouliagmeni Suites** — A relaxed Riviera option steps from the beach, with Saronic Gulf views; a comfortable mid-range base.
